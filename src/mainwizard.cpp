...
QList<InstallStep> MainWizard::buildSteps() const
{
    ...
    if (get("browsers/librewolf")) {
        S << flatpakStep("librewolf", "LibreWolf", "io.gitlab.librewolf-community", "LibreWolf");
    }
    ...
    if (get("comms/thunderbird")) {
        S << flatpakStep("flatpak_thunderbird", "Thunderbird", "org.mozilla.Thunderbird", "Thunderbird");
    }
